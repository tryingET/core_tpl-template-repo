# AGENTS.md — fixture-individual-repo

## Intent
Template for an individual execution repo (mission context + code + tests).
...
- `docs/org_context/**` for lane context overlays.
- `policy/**` for lane governance overlays.
- `ontology/src/system4d.yaml` for lane ontology overlays.
- `.gitlab/ci/rocs.yml` and `scripts/ci/**` for lane gate overlays.
